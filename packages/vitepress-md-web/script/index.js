...
console.log('🚀 ~ bundledLanguages:', Object.keys(bundledLanguages).length, bundledLanguagesInfo.length)

fs.writeFileSync(path.join(import.meta.dirname, './langs.json'), JSON.stringify(Object.keys(bundledLanguages)))
