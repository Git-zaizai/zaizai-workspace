...
import type { LocalSearchTranslations, PageSplitSection } from './local-search'
import type { Awaitable, MarkdownEnv, PageData } from './shared'
  ...
  export interface LocalSearchOptions {
    ...
    miniSearch?: {
      ...
      _splitIntoSections?: (
        path: string,
        html: string
      ) => AsyncGenerator<PageSplitSection> | Generator<PageSplitSection> | Awaitable<PageSplitSection[]>
    }
    /**
