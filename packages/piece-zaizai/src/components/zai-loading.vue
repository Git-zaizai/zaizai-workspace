<template>
  <div class="pos-relative" :style="cssVars">
    <div
    ...
    <div v-if="show" class="zai-body">
      ...
      <slot name="description">
        <p class="text-center text-18 mt-10 text-[--zai-success-color]">{{ descriptionText }}</p>
      </slot>
    </div>
    <div v-if="show && pointerEvents" class="zai-body-qita"></div>
  </div>
</template>
